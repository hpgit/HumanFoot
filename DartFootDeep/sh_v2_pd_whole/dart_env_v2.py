...
class HpDartEnv(gym.Env):
    def __init__(self, env_name='walk'):
        ...
        self.foot_joint.append('j_RightUpLeg')
        self.foot_joint.append('j_RightLeg')
        self.foot_joint.append('j_LeftUpLeg')
        self.foot_joint.append('j_LeftLeg')
        self.foot_joint.append('j_Spine')
        self.foot_joint.append('j_Spine1')
        self.foot_joint.append('j_RightArm')
        self.foot_joint.append('j_RightForeArm')
        self.foot_joint.append('j_LeftArm')
        self.foot_joint.append('j_LeftForeArm')
