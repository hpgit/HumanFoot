...
def main():
    ...
    motion_model_renderer = yr.VpModelRenderer(motionModel, (255,240,255), yr.POLYGON_FILL)
    ...
    def preFrameCallback_Always(frame):
        ...
        if frame < start_frame:
            ...
            setParamVal('com Y offset', -0.065 - (frame - start_frame - 120)*0.0032)
            setParamVal('tiptoe angle', 0.168-(frame-start_frame-120)*0.012)
    ...
    def simulateCallback(frame):
        ...
        controlModel_ik.translateByOffset(np.array([-getParamVal('com X offset')*2., getParamVal('com Y offset'), getParamVal('com Z offset')]))
        ...
        if COLOR_ON:
            for color_key in color.keys():
                motion_model_renderer.body_colors[idDic[color_key]] = color[color_key]
        ...
        if SKELETON_ON:
            ...
            Ts['thigh_R'] = controlModel_ik.getJointTransform(idDic['RightUpLeg'])
            Ts['shin_R'] = controlModel_ik.getJointTransform(idDic['RightLeg'])
            Ts['foot_R'] = controlModel_ik.getJointTransform(idDic['RightFoot'])
            Ts['foot_heel_R'] = controlModel_ik.getJointTransform(idDic['RightFoot'])
            Ts['heel_R'] = np.eye(4)
            Ts['outside_metatarsal_R'] = controlModel_ik.getJointTransform(idDic['RightFoot_foot_0_0'])
            Ts['outside_phalanges_R'] = controlModel_ik.getJointTransform(idDic['RightFoot_foot_0_0_0'])
            # Ts['inside_metatarsal_R'] = controlModel.getJointTransform(idDic['RightFoot_foot_0_1'])
            Ts['inside_metatarsal_R'] = np.eye(4)
            Ts['inside_phalanges_R'] = controlModel_ik.getJointTransform(idDic['RightFoot_foot_0_1_0'])
            Ts['spine_ribs'] = controlModel_ik.getJointTransform(idDic['Spine'])
            Ts['head'] = controlModel_ik.getJointTransform(idDic['Spine1'])
            Ts['upper_limb_R'] = controlModel_ik.getJointTransform(idDic['RightArm'])
            Ts['lower_limb_R'] = controlModel_ik.getJointTransform(idDic['RightForeArm'])
            Ts['thigh_L'] = controlModel_ik.getJointTransform(idDic['LeftUpLeg'])
            Ts['shin_L'] = controlModel_ik.getJointTransform(idDic['LeftLeg'])
            Ts['foot_L'] = controlModel_ik.getJointTransform(idDic['LeftFoot'])
            Ts['foot_heel_L'] = controlModel_ik.getJointTransform(idDic['LeftFoot'])
            Ts['heel_L'] = np.eye(4)
            Ts['outside_metatarsal_L'] = controlModel_ik.getJointTransform(idDic['LeftFoot_foot_0_0'])
            Ts['outside_phalanges_L'] = controlModel_ik.getJointTransform(idDic['LeftFoot_foot_0_0_0'])
            # Ts['inside_metatarsal_L'] = controlModel.getJointTransform(idDic['LeftFoot_foot_0_1'])
            Ts['inside_metatarsal_L'] = np.eye(4)
            Ts['inside_phalanges_L'] = controlModel_ik.getJointTransform(idDic['LeftFoot_foot_0_1_0'])
            Ts['upper_limb_L'] = controlModel_ik.getJointTransform(idDic['LeftArm'])
            Ts['lower_limb_L'] = controlModel_ik.getJointTransform(idDic['LeftForeArm'])
