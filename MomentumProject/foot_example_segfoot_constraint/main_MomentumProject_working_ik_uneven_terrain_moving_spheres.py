...
def main():
    ...
    vpWorld.add_sphere_bump(sphere_radius, (1.6361, -sphere_radius+0.01, -0.2209))
    vpWorld.add_sphere_bump(sphere_radius, (1.4543, -sphere_radius+0.01, -0.2201))
    ...
    def simulateCallback(frame):
        ...
        sphere_radius = 0.03
        vpWorld.set_sphere_bump(0, sphere_radius, (1.6361+(frame%60)*0.001, -sphere_radius+0.02, -0.2209))
        vpWorld.set_sphere_bump(1, sphere_radius, (1.4043+(frame%60)*0.001, -sphere_radius+0.02, -0.2201))
        ...
        for body_id in range(controlModel.getBodyNum()):
            ...
            control_model_renderer.geom_colors[body_id] = [(255, 240, 255)] * controlModel.getBodyGeomNum(body_id)
