...
def main():
    ...
    viewer.doc.addRenderer('extraForceEnable', yr.JointArrowRenderer(rd_exf_des, extraForcePos, (255,0,0), lineWidth=0.004, polygonStyle=yr.POLYGON_FILL))
    ...
    def simulateCallback(frame):
        ...
        if getParamVal('left tilt angle') > 0.001:
            ...
            motion[frame].mulJointOrientationLocal(idDic['LeftFoot'], mm.exp(mm.unitZ(), math.pi * left_tilt_angle/5.))
        ...
        controlModel.translateByOffset(np.array([getParamVal('com X offset'), getParamVal('com Y offset'), getParamVal('com Z offset')]))
