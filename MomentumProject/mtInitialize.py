...
def create_biped():            
    ...
    yme.addJoint(motion, LEFT_PHALANGE_2, 'LEFT_PHALANGE_Effector3', (0.0, 0.0, 0.06))
    yme.addJoint(motion, LEFT_PHALANGE_3, 'LEFT_PHALANGE_Effector2', (0.0, 0.0, 0.06))
    ...
    yme.addJoint(motion, RIGHT_PHALANGE_2, 'RIGHT_PHALANGE_Effector3', (0.0, 0.0, 0.06))
    yme.addJoint(motion, RIGHT_PHALANGE_3, 'RIGHT_PHALANGE_Effector2', (0.0, 0.0, 0.06))
    ...
    config['FootLPart'] = [LEFT_FOOT, LEFT_TALUS_2, LEFT_CALCANEUS_1, LEFT_METATARSAL_1, LEFT_METATARSAL_3, LEFT_PHALANGE_1, LEFT_PHALANGE_3]
    config['FootRPart'] = [RIGHT_FOOT, RIGHT_TALUS_2, RIGHT_CALCANEUS_1, RIGHT_METATARSAL_1, RIGHT_METATARSAL_3, RIGHT_PHALANGE_1, RIGHT_PHALANGE_3]
