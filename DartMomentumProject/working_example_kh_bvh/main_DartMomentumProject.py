...
def main():
    ...
    dartModel.skeleton.set_positions(motion[0].get_q())
    ...
    def simulateCallback(frame):
        ...
        for i in range(stepsPerFrame):
            ...
            # dartModel.skeleton.set_forces(np.zeros_like(ddth_des_flat))
            # dartModel.skeleton.set_positions(motion[frame].get_q())
            # dartModel.step()
            pass
        dartModel.skeleton.set_positions(motion[frame].get_q())
    ...
    def preFrameCallback(frame):
        dartModel.skeleton.set_positions(motion[frame].get_q())
        print("motion: ", motion.getJointPositionGlobal(motion[frame].skeleton.getJointIndex("LeftLeg"), frame))
        print("controller: ", dartModel.getJointPositionGlobal("j_LeftLeg"))
