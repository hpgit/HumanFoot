...
def create_biped():            
    ...
    if FOOT_PART_NUM == 4 :
        ...
        yme.rotateJointLocal(motion, RIGHT_METATARSAL_1, mm.exp(mm.v3(1.,0.0,0.0), .45), False)
        yme.rotateJointLocal(motion, RIGHT_METATARSAL_2, mm.exp(mm.v3(1.,0.0,0.0), .45), False)
        ...
        yme.rotateJointLocal(motion, LEFT_METATARSAL_1, mm.exp(mm.v3(1.,0.0,0.0), .45), False)
        yme.rotateJointLocal(motion, LEFT_METATARSAL_2, mm.exp(mm.v3(1.,0.0,0.0), .45), False)
    ...
    if FOOT_PART_NUM == 1:
        ...
        config['weightMap']={RIGHT_ARM:.2, RIGHT_FORE_ARM:.2, LEFT_ARM:.2, LEFT_FORE_ARM:.2, SPINE:.3, SPINE1:.3, RIGHT_FOOT:.3, LEFT_FOOT:.3, HIP:.5,
                        RIGHT_UP_LEG:.1, RIGHT_LEG:.3, LEFT_UP_LEG:.1, LEFT_LEG:.3, 
                        LEFT_METATARSAL_1:.2, LEFT_METATARSAL_2:.2, RIGHT_METATARSAL_1:.2, RIGHT_METATARSAL_2:.2, 
                        LEFT_PHALANGE_1:.2, LEFT_PHALANGE_2:.2, RIGHT_PHALANGE_1:.2, RIGHT_PHALANGE_2:.2}
        config['weightMap2']={RIGHT_ARM:.2, RIGHT_FORE_ARM:.2, LEFT_ARM:.2, LEFT_FORE_ARM:.2, SPINE:1., SPINE1:.3, RIGHT_FOOT:2.5, LEFT_FOOT:2.5, HIP:1.,
                        RIGHT_UP_LEG:1., RIGHT_LEG:1., LEFT_UP_LEG:1., LEFT_LEG:1.,                         
                        LEFT_METATARSAL_1:.3, LEFT_METATARSAL_2:.3, RIGHT_METATARSAL_1:.3, RIGHT_METATARSAL_2:.3, 
                        LEFT_PHALANGE_1:.3, LEFT_PHALANGE_2:.3, RIGHT_PHALANGE_1:.3, RIGHT_PHALANGE_2:.3}
    '''
    elif FOOT_PART_NUM == 5:
        config['weightMap']={RIGHT_ARM:.2, RIGHT_FORE_ARM:.2, LEFT_ARM:.2, LEFT_FORE_ARM:.2, SPINE:.3, SPINE1:.3, RIGHT_FOOT:.3, LEFT_FOOT:.3, HIP:.5,
    ...
    if FOOT_PART_NUM == 5:
        config['FootLPart'] = [LEFT_FOOT, LEFT_METATARSAL_1, LEFT_METATARSAL_2, LEFT_PHALANGE_1, LEFT_PHALANGE_2]
        config['FootRPart'] = [RIGHT_FOOT, RIGHT_METATARSAL_1, RIGHT_METATARSAL_2, RIGHT_PHALANGE_1, RIGHT_PHALANGE_2]
    else :
...
def buildMassMap():
    ...
    massMap = massMap.fromkeys([HEAD, HEAD_END, HIP, LEFT_ARM, LEFT_FOOT, LEFT_FORE_ARM, LEFT_HAND, LEFT_HAND_END, LEFT_LEG, LEFT_SHOULDER, LEFT_TOES, LEFT_TOES_END, LEFT_UP_LEG, RIGHT_ARM, RIGHT_FOOT, RIGHT_FORE_ARM, RIGHT_HAND, RIGHT_HAND_END, RIGHT_LEG, RIGHT_SHOULDER, RIGHT_TOES, RIGHT_TOES_END, RIGHT_UP_LEG, SPINE, SPINE1, LEFT_PHALANGE, RIGHT_PHALANGE, LEFT_TARSUS, RIGHT_TARSUS
                                ...
                                LEFT_METATARSAL_1, LEFT_METATARSAL_2, LEFT_PHALANGE_1, LEFT_PHALANGE_2,
                                RIGHT_METATARSAL_1, RIGHT_METATARSAL_2, RIGHT_PHALANGE_1, RIGHT_PHALANGE_2], 0.)
    ...
    massMap[LEFT_METATARSAL_1] += 2.
    massMap[LEFT_METATARSAL_2] += 2.
    massMap[LEFT_PHALANGE_1] += 4.
    massMap[LEFT_PHALANGE_2] += 2.
    massMap[RIGHT_METATARSAL_1] += 2.
    massMap[RIGHT_METATARSAL_2] += 2.
    massMap[RIGHT_PHALANGE_1] += 4.
    massMap[RIGHT_PHALANGE_2] += 2.
